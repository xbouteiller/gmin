...
class ParseTreeFolder(): 
    ...
    def __init__(self,                
        ...
        self.use_opt = self.parser.get("config", "use_opt")
        ...
        if self. use_opt == 'True':
            ...
            self.metadata = self.parser.get("config", "metadata") 
            ...
            self.metadata = file.replace('/','/')
            print('Metadata file path is {}'.format(self.metadata)) 
            print('\n')
